...
class SandboxInstance {
  ...
  async startE2B() {
    ...
    // NOTE: Requires 'e2b' npm package and infrastructure setup
    throw new Error(
      "E2B Sandbox integration is currently in development and requires the 'e2b' SDK. Please use 'docker' or 'local' for now.",
    );
  }
  ...
  async executeE2B(scriptName, params) {
    throw new Error(
      "E2B execution not implemented. Requires E2B SDK integration.",
    );
  }
